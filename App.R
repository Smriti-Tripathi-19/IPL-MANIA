...
get.batters <- function(x){
  foo <- paste0("C:/Users/asus/Downloads/class-project-group-11-1-main/class-project-group-11-1-main/Data Sets/Batters", x, ".RData")
  return(foo)
}

get.bowlers <- function(x){
  foo <- paste0("C:/Users/asus/Downloads/class-project-group-11-1-main/class-project-group-11-1-main/Data Sets/Bowlers", x, ".RData")
  return(foo)
}

get.FinalPoints <- function(x){
  foo <- paste0("C:/Users/asus/Downloads/class-project-group-11-1-main/class-project-group-11-1-main/Data Sets/FinalPoints", x, ".RData")
  return(foo)
}
...
load("C:/Users/asus/Downloads/class-project-group-11-1-main/class-project-group-11-1-main/Data Sets/CoordCountBowl23.RData")
load("C:/Users/asus/Downloads/class-project-group-11-1-main/class-project-group-11-1-main/Data Sets/CoordCountBat23.RData")
                ...
                navbarPage(
                  ...
                  tabPanel("Visualization",
                           sidebarPanel(
                             ...
                             selectInput("vis.type", "chose which stat", c("Average(SR)", "Top Scorers", "Best Score", "Runs vs Wicket", "Bowling comparison", "Average Density by Team", "Balls vs Wickets")),
